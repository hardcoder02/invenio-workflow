...
public class IntersectionOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "intersection";
	...
	public IntersectionOperation() {
		super(null, OP_NAME);
	}
	
	public IntersectionOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return processIntersection(g1, g2, graphName);
	}

	private InvenioGraph processIntersection(InvenioGraph g1, InvenioGraph g2, String graphName) {
