...
public class GreaterOrEqualOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "greaterOrEqual";
	...
	public GreaterOrEqualOperation() {
		super(null, OP_NAME);
	}
	
	public GreaterOrEqualOperation(String id) {
		super(id, OP_NAME);
	}
