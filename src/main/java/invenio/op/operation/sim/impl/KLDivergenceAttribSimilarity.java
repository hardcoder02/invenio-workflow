...
public class KLDivergenceAttribSimilarity extends AbstractAttributeSimilarity {
	
	public final static String OP_NAME = "KLDivergenceAttribSimilarity";
	
	public KLDivergenceAttribSimilarity() {
		super(null, OP_NAME);
	}
	
	public KLDivergenceAttribSimilarity(String id) {
		super(id, OP_NAME);
	}
