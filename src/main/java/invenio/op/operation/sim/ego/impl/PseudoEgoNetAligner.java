...
public class PseudoEgoNetAligner extends AbstractEgoNetAligner {
	...
	private void alignGraphs(InvenioVertex n1, InvenioVertex n2, boolean sameGraph) throws QueryException {
		...
		// iterate over pairs1, in parallel pairs2
		...
		while (iter1.hasNext()) {
			...
			Pair<InvenioVertex, InvenioEdge> p2 = null;
		...
		// iterate over remaining elements of pairs2
		while (iter2.hasNext()) {
