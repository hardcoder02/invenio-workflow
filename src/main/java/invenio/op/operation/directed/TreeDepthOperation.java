...
public class TreeDepthOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "treeDepth";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public TreeDepthOperation() {
		super(null, OP_NAME);
	}
	
	public TreeDepthOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.getTreeDepth(root);
