...
public class SiblingsOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "siblings";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public SiblingsOperation() {
		super(null, OP_NAME);
	}
	
	public SiblingsOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.getSiblings(v);
	}
}
