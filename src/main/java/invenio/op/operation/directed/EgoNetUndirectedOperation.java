...
public class EgoNetUndirectedOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "egoNetUndirected";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public EgoNetUndirectedOperation() {
		super(null, OP_NAME);
	}
	
	public EgoNetUndirectedOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.getEgoNetUndirected(v);
	}
}
