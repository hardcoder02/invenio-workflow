...
public class ParentsOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "parents";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public ParentsOperation() {
		super(null, OP_NAME);
	}
	
	public ParentsOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.getParents(v);
	}
}
