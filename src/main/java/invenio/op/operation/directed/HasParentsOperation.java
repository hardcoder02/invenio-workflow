...
public class HasParentsOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "hasParents";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public HasParentsOperation() {
		super(null, OP_NAME);
	}
	
	public HasParentsOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.hasParents(v);
	}
}
