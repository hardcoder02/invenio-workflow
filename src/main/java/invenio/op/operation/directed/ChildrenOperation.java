...
public class ChildrenOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "children";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public ChildrenOperation() {
		super(null, OP_NAME);
	}
	
	public ChildrenOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.getChildren(v);
	}
}
