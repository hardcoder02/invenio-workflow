...
public class SwitchCountPositiveOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "switchCountPositive";
	...
	public SwitchCountPositiveOperation() {
		super(null, OP_NAME);
	}
	
	public SwitchCountPositiveOperation(String id) {
		super(id, OP_NAME);
	}
...
//				if ( f1 == null || f2 == null )
//					return null;
				return "FALSE".equalsIgnoreCase( f1.getValue() ) && "TRUE".equalsIgnoreCase( f2.getValue() );
			}
		});
