...
public class AdjacentVerticesUndirectedOperation extends AbstractOperation implements
		CompiledOperation {
	
	public final static String OP_NAME = "adjacentVerticesUndirected";

	public static final Class[] EXPECTED_TYPES = {
		InvenioVertex.class
	};
	
	public AdjacentVerticesUndirectedOperation() {
		super(null, OP_NAME);
	}
	
	public AdjacentVerticesUndirectedOperation(String id) {
		super(id, OP_NAME);
	}
	...
	public Object doExecute(Object[] args) throws QueryException {
		...
		return DirectedUtils.getAdjacentVerticesUndirected(v);
	}
}
