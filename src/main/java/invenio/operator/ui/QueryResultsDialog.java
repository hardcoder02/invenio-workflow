...
/**
 * DatabaseLoadFrame is a gui frame that takes the user selected url, username,
 * and password and creates a database connection.  It then automatically
 * creates an instance of a DatabaseImportFrame
 */
