...
public class SimpleKeyEdgeTransformationFunction implements
	...
	public InvenioEdge createEdge( Map<String, InvenioVertex> vertexMap, InvenioEdge gEdge, InvenioEdge hEdge) {
		...
		if ( !vertexMap.containsKey( vKey1 )
			...
			throw new IllegalArgumentException("Misaligned  vertices");
...
//		edge.importUserData(gEdge);
//		edge.importInvenioData(gEdge);
		return edge;
	}
