...
public class TabDelimIO {	
	 ...
	 */
	public void readGraph(InvenioGraph graph, String graphFile, String nodesFile, String edgesFile) throws IOException, DataFormatException {
		...
		try {
			nodeReader = getReader(nodesFile);
	...
	/**
	 * Reads data from a tab delimited format and puts it into a Prefuse Graph
	 * object.
	 * 
	 * @param graphFile GRAPH file (currently not used)
	 * @param nodesFile NODE file
	 ...
	 * @return Prefuse Graph object
	 */
	public InvenioGraph readGraph(String graphFile, String nodesFile, String edgesFile) throws IOException, DataFormatException {
		
		graph = new InvenioGraph();
		BufferedReader nodeReader = null;
		BufferedReader edgeReader = null;
	 ...
	 * @param fr
	 */
	private void readNodes(BufferedReader fr) throws DataFormatException, IOException {
...
//		InvenioEdge edge = new InvenioEdge(n1, n2);
	...
	public static void main(String[] args) throws DataFormatException, IOException {
		String nodeFile =
			"/home/ncesario/data/synthetic/predictedgraph1/g-1-2-1.NODE.person.tab";
		String edgeFile =
			"/home/ncesario/data/synthetic/predictedgraph1/g-1-2-1.UNDIRECTED.friend.tab";
		InvenioGraph g = (new TabDelimIO()).readGraph(null, nodeFile, edgeFile);
