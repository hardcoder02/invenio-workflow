 ...
 *
 */
public class SimpleNodeByLocation {
	...
	public static LogicalExpression createWhereClause() {
		LogicalOperator whereClause = new LogicalOperatorImpl("in");
		
		LogicalConstant inLiteral = new LogicalConstant("RCB");
